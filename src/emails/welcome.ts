    ...
    html: buildEmailLayout({
      ...
      body: `
        ...
        <div style="background-color:#f3f4f6;border-radius:8px;padding:20px;margin-bottom:24px;">
          <p style="margin:0 0 8px;font-size:14px;color:#374151;font-weight:600;">Suas credenciais de acesso:</p>
          <p style="margin:0 0 4px;font-size:14px;color:#374151;">Email: <strong>${escapeHtml(email)}</strong></p>
          <p style="margin:0;font-size:14px;color:#374151;">Senha temporária: <strong>${escapeHtml(tempPassword)}</strong></p>
        </div>
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" style="padding-bottom:28px;">
              <a href="${loginUrl}" style="display:inline-block;padding:14px 32px;background-color:#10b981;color:#ffffff;text-decoration:none;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.2px;">
                Acessar Plataforma
              </a>
            </td>
          </tr>
