...
--> statement-breakpoint
CREATE UNIQUE INDEX "pns_project_user_event_unique" ON "project_notification_settings" USING btree ("project_id","user_id","event_type");
--> statement-breakpoint
CREATE INDEX "idx_pns_project_event" ON "project_notification_settings" USING btree ("project_id","event_type");
--> statement-breakpoint
CREATE TABLE "project_notification_emails" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  "project_id" uuid NOT NULL,
...
ALTER TABLE "project_notification_emails"
  ...
  FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
CREATE UNIQUE INDEX "pne_project_email_event_unique" ON "project_notification_emails" USING btree ("project_id","email","event_type");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "users"
  ADD COLUMN "urgent_notifications_enabled" boolean DEFAULT false NOT NULL,
  ADD COLUMN "notification_sound_enabled" boolean DEFAULT false NOT NULL;
